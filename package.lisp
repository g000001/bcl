...
(cl:defpackage "BCL"
  ...
  ;;
  (:export eval-after-load source-pathname)
...
(cl:defpackage "1D741711-0401-5576-80C1-353116694E87" 
  (:use #:bcl #:c2mop)
  (:documentation "(uuid:make-v5-uuid uuid:+namespace-dns+ \"bcl:internal\")"))


(defmacro bcl::in-sub-package ()
  '(in-package "1D741711-0401-5576-80C1-353116694E87"))
